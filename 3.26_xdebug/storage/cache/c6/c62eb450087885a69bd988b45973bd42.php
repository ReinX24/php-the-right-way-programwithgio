...
/* invoices/index.twig */
class __TwigTemplate_2a62e74f4e0cdb0974f0820c50b05cfe extends Template
{
    private $source;
    private $macros = [];
...
<table>
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["invoice"]) {
            ...
            <td>";
            // line 27
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extra\Intl\IntlExtension']->formatCurrency(CoreExtension::getAttribute($this->env, $this->source, $context["invoice"], "amount", [], "any", false, false, false, 27), "USD"), "html", null, true);
            yield "</td>
            <td>";
            // line 28
